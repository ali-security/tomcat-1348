...
public final class CGIServlet extends HttpServlet {
    ...
    protected class CGIEnvironment {
        ...
        protected String[] findCGI(String pathInfo, String webAppRootDir, String contextPath, String servletPath,
            ...
            // Overload retained for backwards compatibility; webAppRootDir is ignored.
            return findCGI(contextPath, servletPath, pathInfo, cgiPathPrefix);
        }

        protected String[] findCGI(String contextPath, String servletPath, String pathInfo,
                String cgiPathPrefix) {
            ...
            if (path == null) {
                /*
                 * The script doesn't exist directly on the file system. It might be located in
                 * an archive or similar. Such scripts are extracted to the web application's
